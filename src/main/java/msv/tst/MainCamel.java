...
public class MainCamel {
    ...
    static class MainRouteBuilder extends RouteBuilder {
        @Override
        public void configure() throws Exception {

            from(TOPIC + "?selector=MCP_SYSTEM_HEADER NOT LIKE '%tradeRefNbr\":\"JM001%'")
                    .routeId("dev-route")
                    .process(e -> {
                        System.out.println(e.getFromRouteId() + " HEADER= " + e.getIn().getHeader(MCP_SYSTEM_HEADER) + " body= " + e.getIn().getBody());
                    })
                    .end();
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            camelContext.addRoutes(new MainRouteBuilder());
